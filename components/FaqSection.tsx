...
const faqData = [
  ...
  // بخش فنی و مدل‌ها
  {
    ...
    answer:
      "ما از مدل‌های پیشرو در صنعت مانند سری GPT-4o و GPT-4 از OpenAI، مدل Gemini از Google، سری Claude 3 از Anthropic و مدل‌های تخصصی برای تولید تصویر (مانند DALL-E 3) و صدا پشتیبانی می‌کنیم. این لیست دائماً در حال به‌روزرسانی است."
  },
  {
