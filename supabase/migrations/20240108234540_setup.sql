...
AS $$
DECLARE
  project_url TEXT := 'https://vkwgwiiesvyfcgaemeck.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZrd2d3aWllc3Z5ZmNnYWVtZWNrIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1NDM5MjAyMCwiZXhwIjoyMDY5OTY4MDIwfQ.0TyvvmR-gxb-rYw6ocAX6pfUf4EXjMcJ9avyAEyBY9A'; -- full access needed for http request to storage
