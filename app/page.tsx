...
export const metadata: Metadata = {
  title: "هوش مصنوعی RhynoAI | پلتفرم ابزارهای هوشمند AI",
  description:
    "با RhynoAI به دنیای هوش مصنوعی قدم بگذارید. ابزارهای پیشرفته تولید محتوا، سئو، و تحلیل داده مبتنی بر هوش مصنوعی برای کسب و کار شما.",
  keywords: [
    "تولید محتوای اینستاگرام با هوش مصنوعی رایگان",
    "بهترین ابزار هوش مصنوعی برای سئو فارسی",
    "ابزار هوش مصنوعی فارسی",
    "ابزار هوش مصنوعی",
    "هوش مصنوعی رایگان بدون محدودیت",
    "AI",
    "هوش مصنوعی",
    "مدل‌های AI",
    "Rhyno AI",
