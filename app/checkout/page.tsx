        ...
        >
          ...
          >
            <h1 className="text-3xl font-extrabold text-blue-400 sm:text-5xl lg:text-6xl">
              صفحه پرداخت <span className="text-white">Rhyno</span>
            </h1>
          ...
          >
            ...
            <p className="mx-auto max-w-4xl text-base leading-relaxed text-gray-300 sm:text-lg lg:text-xl">
              ...
              <br />
              <br />
              تیم ما پلتفرم را با تمرکز روی راحتی شما ساخته است. بدون فیلترشکن و
              با اتصال مستقیم، به تمام مدل‌ها دسترسی دارید. همه چیز سریع، امن و
              قابل اعتماد است.
              <br />
              <br />
              امنیت داده‌ها اولویت اصلی ماست؛ هیچ کس جز شما به داده‌هایتان
              دسترسی ندارد. تمام ارتباطات شما با رمزنگاری پیشرفته محافظت می‌شود
              و داده‌هایتان در سرورهای امن ایرانی نگهداری می‌شود.
              <br />
              <br />
              تجربه هوش مصنوعی باید ساده و منعطف باشد. هر مدلی که نیاز دارید را
              انتخاب، امتحان و در هر مرحله تصمیم بگیرید چقدر هزینه کنید. شما
              کنترل کامل بودجه‌تان را دارید و می‌توانید در هر لحظه مصرف خود را
              بررسی کنید.
              <br />
              <br />
              ...
              باشید. هدف ما ارائه هوش مصنوعی در دسترس، شفاف و با بیشترین اعتماد
              است. ما متعهد هستیم که بهترین کیفیت خدمات را با منصفانه‌ترین
              قیمت‌ها به شما ارائه دهیم.
              <br />
              <br />
              <span className="font-semibold text-blue-400">
                هزاران کاربر ایرانی قبل از شما این تصمیم هوشمندانه را گرفته‌اند.
              </span>{" "}
              از مدل‌های پیشرفته OpenAI تا Claude و Gemini، همه را در یک مکان
              تجربه کنید.
              <br />
              <br />
              شروع کنید، تست کنید و ببینید چقدر می‌توانید صرفه‌جویی کنید. با پلن
              Pay as you go، هر تومان شما ارزش واقعی دارد و هدر نمی‌شود.
            </p>
          </motion.div>
          ...
          >
            ...
            >
              <div className="mb-3 text-2xl text-blue-400">🚀</div>
              <h3 className="mb-2 text-xl font-bold text-white">دسترسی فوری</h3>
              <p className="text-sm text-gray-300">
                شروع فوری بدون هیچ تعهد ماهانه. هر زمان که بخواهید استفاده کنید،
                هر زمان که بخواهید متوقف کنید.
              </p>
            </motion.div>
            ...
            >
              <div className="mb-3 text-2xl text-blue-400">🔄</div>
              <h3 className="mb-2 text-xl font-bold text-white">انعطاف کامل</h3>
              <p className="text-sm text-gray-300">
          ...
          >
            <div className="grid grid-cols-2 gap-6 text-center md:grid-cols-4">
              <div>
                <div className="text-3xl font-bold text-blue-400">+۱۰,۰۰۰</div>
